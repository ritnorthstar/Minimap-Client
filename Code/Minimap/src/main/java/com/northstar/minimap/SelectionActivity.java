...
public class SelectionActivity extends Activity {
	...
	public void setMaps(){
		...
		ArrayAdapter<String> mapAdapter = new ArrayAdapter<String>(this, R.layout.selection_spinner_item, mapChoices);
	...
	public void setTeams(){
		...
		ArrayAdapter<String> teamAdapter = new ArrayAdapter<String>(this, R.layout.selection_spinner_item, teamChoices);
